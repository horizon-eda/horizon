...
namespace horizon {
	FootprintGeneratorQuad::FootprintGeneratorQuad(CorePackage *c): Glib::ObjectBase (typeid(FootprintGeneratorQuad)), FootprintGeneratorBase("/net/carrotIndustries/horizon/imp/footprint_generator/quad.svg", c) {
			update_preview();
