...
{
    program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/marker-vertex.glsl",
                                              "/net/carrotIndustries/horizon/src/canvas/marker-fragment.glsl",
