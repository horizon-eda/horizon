...
{
    program = gl_create_program_from_resource("/net/carrotIndustries/horizon/lib/canvas/shaders/marker-vertex.glsl",
                                              "/net/carrotIndustries/horizon/lib/canvas/shaders/marker-fragment.glsl",
