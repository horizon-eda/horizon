...
{
    program =
            gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/grid-vertex.glsl",
                                            "/net/carrotIndustries/horizon/src/canvas/grid-fragment.glsl", nullptr);
