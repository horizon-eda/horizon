...
void Grid::realize()
{
    program = gl_create_program_from_resource("/net/carrotIndustries/horizon/lib/canvas/shaders/grid-vertex.glsl",
                                              "/net/carrotIndustries/horizon/lib/canvas/shaders/grid-fragment.glsl",
                                              nullptr);
