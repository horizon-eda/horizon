...
{
    program = gl_create_program_from_resource("/net/carrotIndustries/horizon/lib/canvas3d/shaders/wall-vertex.glsl",
                                              "/net/carrotIndustries/horizon/lib/canvas3d/shaders/wall-fragment.glsl",
