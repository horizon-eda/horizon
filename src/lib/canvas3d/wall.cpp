...
{
    program = gl_create_program_from_resource("/net/carrotIndustries/horizon/src/canvas/wall-vertex.glsl",
                                              "/net/carrotIndustries/horizon/src/canvas/wall-fragment.glsl",
