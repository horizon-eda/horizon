...
std::pair<bool, std::string> Package::MyParameterProgram::set_polygon(const ParameterProgram::TokenCommand *cmd,
...
std::pair<bool, std::string> Package::MyParameterProgram::expand_polygon(const ParameterProgram::TokenCommand *cmd,
                                                                         std::deque<int64_t> &stack)
{
