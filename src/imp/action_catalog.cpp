...
const std::map<std::pair<ActionID, ToolID>, ActionCatalogItem> action_catalog = {
        ...
        {{ActionID::TOOL, ToolID::MOVE_KEY_UP_COARSE},
         {"Move up coarse", ActionGroup::MOVE, ActionCatalogItem::AVAILABLE_EVERYWHERE,
          ActionCatalogItem::FLAGS_NO_MENU | ActionCatalogItem::FLAGS_NO_POPOVER}},

        {{ActionID::TOOL, ToolID::MOVE_KEY_DOWN_COARSE},
         {"Move down coarse", ActionGroup::MOVE, ActionCatalogItem::AVAILABLE_EVERYWHERE,
          ActionCatalogItem::FLAGS_NO_MENU | ActionCatalogItem::FLAGS_NO_POPOVER}},

        {{ActionID::TOOL, ToolID::MOVE_KEY_LEFT_COARSE},
         {"Move left coarse", ActionGroup::MOVE, ActionCatalogItem::AVAILABLE_EVERYWHERE,
          ActionCatalogItem::FLAGS_NO_MENU | ActionCatalogItem::FLAGS_NO_POPOVER}},

        {{ActionID::TOOL, ToolID::MOVE_KEY_RIGHT_COARSE},
         {"Move right coarse", ActionGroup::MOVE, ActionCatalogItem::AVAILABLE_EVERYWHERE,
          ActionCatalogItem::FLAGS_NO_MENU | ActionCatalogItem::FLAGS_NO_POPOVER}},
...
const LutEnumStr<ToolID> tool_lut = {TOOL_LUT_ITEM(EDIT_SCHEMATIC_PROPERTIES),
                                     ...
                                     TOOL_LUT_ITEM(MOVE_KEY_UP_COARSE),
                                     TOOL_LUT_ITEM(MOVE_KEY_DOWN_COARSE),
                                     TOOL_LUT_ITEM(MOVE_KEY_LEFT_COARSE),
                                     TOOL_LUT_ITEM(MOVE_KEY_RIGHT_COARSE),
