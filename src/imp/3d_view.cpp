...
namespace horizon {
	...
	View3DWindow::View3DWindow(BaseObjectType* cobject, const Glib::RefPtr<Gtk::Builder>& x, const class Board *bo, class Pool *p) :
		...
		canvas->signal_models_loading().connect([this, model_loading_revealer](bool v) {
