...
void DragSelection::Box::update()
{
    ...
    if (sq == CanvasGL::SelectionQualifier::TOUCH_BOX) {
        Coordf sz1{sel_width / 2, sel_height / 2};
        rotate(sz1.x, sz1.y, -sel_angle);
        Coordf sz2{sel_width / 2, sel_height / -2};
        rotate(sz2.x, sz2.y, -sel_angle);
