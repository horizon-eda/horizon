...
SRC_IMP = \
	...
	src/util/stock_info_provider_local.cpp\
	src/util/stock_info_provider_local_editor.cpp\
...
SRC_POOL_PRJ_MGR = \
	...
	src/pool-prj-mgr/preferences/preferences_window_stock_info_local.cpp\
